...
let currentAlertInstance: any = null
...
export default defineNuxtPlugin(() => {
  const show = (options: AlertOptions) => {
    ...
    container.className = 'fixed left-1/2 -translate-x-1/2 top-16 w-full px-4 z-50 flex flex-col items-center gap-4'
    ...
    currentAlertInstance = app.mount(container)
